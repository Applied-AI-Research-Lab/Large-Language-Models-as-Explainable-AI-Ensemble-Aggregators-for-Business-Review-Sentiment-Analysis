# python3 NB/5_training_phase.py --pipeline balanced
# python3 NB/5_training_phase.py --pipeline natural
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Training phase for TF-IDF + Naive Bayes.")
    ...
    parser.add_argument("--output-base-dir", type=Path, default=Path("NB/trained_models"))
    ...
    joblib.dump({"estimator": model, "label_offset": 1, "model_family": "NB"}, model_path)
