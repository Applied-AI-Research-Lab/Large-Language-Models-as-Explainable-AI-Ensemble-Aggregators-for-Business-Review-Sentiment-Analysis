# python3 NB/6_prediction_phase.py \
#   --model-path NB/final_model_selection/balanced_wider_250/best_model.joblib \
#   --input-csv Datasets/test_balanced.csv \
#   --output-csv NB/predictions/preds_nb_balanced_on_balanced.csv --overwrite

# python3 NB/6_prediction_phase.py \
#   --model-path NB/final_model_selection/natural_wider_250/best_model.joblib \
#   --input-csv Datasets/test_natural.csv \
#   --output-csv NB/predictions/preds_nb_natural_on_natural.csv --overwrite
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Prediction phase for TF-IDF + Naive Bayes.")
