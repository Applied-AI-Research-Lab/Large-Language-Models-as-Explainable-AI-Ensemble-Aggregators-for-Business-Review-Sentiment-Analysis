# python3 LR/5_training_phase.py --pipeline balanced
# python3 LR/5_training_phase.py --pipeline natural
import argparse
import json
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Training phase for TF-IDF + Logistic Regression.")
    ...
    parser.add_argument("--output-base-dir", type=Path, default=Path("LR/trained_models"))
    ...
    joblib.dump({"estimator": model, "label_offset": 1, "model_family": "LR"}, model_path)
