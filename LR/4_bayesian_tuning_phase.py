# python3 LR/4_bayesian_tuning_phase.py --pipeline balanced --n-trials 200 --startup-trials 20
# python3 LR/4_bayesian_tuning_phase.py --pipeline natural --n-trials 200 --startup-trials 20

# For slightly wider but still controlled search:
# python3 LR/4_bayesian_tuning_phase.py --pipeline balanced --n-trials 250 --startup-trials 25 --c-max 5.0 --class-weight-mode search
# python3 LR/4_bayesian_tuning_phase.py --pipeline natural --n-trials 250 --startup-trials 25 --c-max 5.0 --class-weight-mode search
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Bayesian tuning for TF-IDF + Logistic Regression.")
    ...
    output_dir = args.output_dir or Path(f"LR/tuning_outputs/{args.pipeline}")
